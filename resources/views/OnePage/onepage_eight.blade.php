                        ...
                        <div class="portfolio_wrap">
                            <div class="filter row portfolio-feed personal g-5">
                                <div class="flash grid-item-p element-item transition creative col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/07.jpg') }}"src="{{ asset('assets/images/product/07.jpg') }}"
                                ...
                                <div class="flash grid-item-p element-item transition design col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/02.jpg') }}"src="{{ asset('assets/images/product/02.jpg') }}"
                                                alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                ...
                                <div class="flash grid-item-p element-item transition photo col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/03.jpg') }}"src="{{ asset('assets/images/product/03.jpg') }}"
                                                alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                ...
                                <div class="flash grid-item-p element-item transition photo style col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/04.jpg') }}"src="{{ asset('assets/images/product/04.jpg') }}"
                                                alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                ...
                                <div class="flash grid-item-p element-item transition creative col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/05.jpg') }}"src="{{ asset('assets/images/product/05.jpg') }}"
                                                alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                ...
                                <div class="flash grid-item-p element-item transition photo style design col-md-6 col-sm-6"
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="{{ route('projects-details') }}" class="thumbnail">
                                            <img src="{{ asset('assets/images/product/06.jpg') }}"src="{{ asset('assets/images/product/06.jpg') }}"
                                                alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
