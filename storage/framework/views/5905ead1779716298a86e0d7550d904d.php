                    ...
                    <div class="header-mida-area style-two">
                        <div class="logo-area-start">
                            <a href="<?php echo e(route('index')); ?>">
                                <img src="<?php echo e(asset('assets/images/logo/logo-blue.png')); ?>" alt="logo">
                            </a>
                        </div>
...
<?php endif; ?>
    ...
    <div class="banner-area banner-style-two bg_image tmp-section-gapTop">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 offset-lg-2  order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1">
                    <div class="banner-two-thumbnail">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/banner/banner-two-2.png')); ?>" alt="Business_Corporate" data-sal-delay="250" data-sal="slide-left" data-sal-duration="800">
                            <div class="product-share product-share-style-two">
                                ...
                                <div class="profile-share">
                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/4.png')); ?>" alt="education"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/5.png')); ?>" alt="education"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/6.png')); ?>" alt="education"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/7.png')); ?>" alt="education"></a>
                                </div>
                            </div>
        ...
        <div class="bg-circle">
            <img src="<?php echo e(asset('assets/images/banner/banner-circle.png')); ?>" alt="banner">
        </div>

        <div class="bg-dolour">
            <img src="<?php echo e(asset('assets/images/banner/banner-dolour.png')); ?>" alt="banner">
        </div>

        <div class="bg-blue-circle">
            <img src="<?php echo e(asset('assets/images/banner/blue-circle.png')); ?>" alt="banner">
        </div>

        <div class="bg-curly-lines">
            <img src="<?php echo e(asset('assets/images/banner/curly-lines.png')); ?>" alt="banner">
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-right" data-sal-duration="800">
                    <div class="about-thumbnails about-style-two">
                        <img src="<?php echo e(asset('assets/images/about/about-style-2.png')); ?>" alt="Business Consulting about">

                        <div class="dots animated tada">
                            <img class="tada" src="<?php echo e(asset('assets/images/about/dots.png')); ?>" alt="Business Consulting dots">
                        </div>
                        <div class="scater">
                            <img src="<?php echo e(asset('assets/images/about/scater.png')); ?>" alt="Business Consulting scater">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="history-inner style-one">
                        <div class="custom-icon">
                            <img src="<?php echo e(asset('assets/images/counter/01.png')); ?>" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="history-inner style-one">
                        <div class="custom-icon">
                            <img src="<?php echo e(asset('assets/images/counter/02.png')); ?>" alt="">
                        </div>
                        <div class="counter-wrapper">
                            <div class="single-counter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="history-inner style-one">
                        <div class="custom-icon">
                            <img src="<?php echo e(asset('assets/images/counter/03.png')); ?>" alt="">
                        </div>
                        <div class="counter-wrapper">
                            <div class="single-counter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="history-inner style-one">
                        <div class="custom-icon">
                            <img src="<?php echo e(asset('assets/images/counter/04.png')); ?>" alt="">
                        </div>
                        <div class="counter-wrapper">
                            <div class="single-counter">
        ...
        <div class="container">
                ...
                <div class="col-lg-7 col-md-6 mt_md--80 mt_sm--50 " data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner" data-tmp-cursor="lg" data-tmp-cursor-text="View Details">
                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-1.png')); ?>" alt="corporate business">
                        </a>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner" data-tmp-cursor="lg" data-tmp-cursor-text="View Details">
                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-2.png')); ?>" alt="corporate business">
                        </a>
                ...
                <div class="col-lg-4 col-md-6" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner" data-tmp-cursor="lg" data-tmp-cursor-text="View Details">
                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-3.png')); ?>" alt="corporate business">
                        </a>
                        <div class="portfolio-tag portfolio-md-tag">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
                ...
                <div class="col-lg-4 col-md-6" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner" data-tmp-cursor="lg" data-tmp-cursor-text="View Details">
                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-4.png')); ?>" alt="corporate business">
                        </a>
                        <div class="portfolio-tag portfolio-md-tag">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
            ...
            <div class="row">
                <div class="work-top-inner">
                    ...
                    <div class="scater-line">
                        <img src="<?php echo e(asset('assets/images/work/shape.png')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="inner">
                        <a href="#">
                            <div class="thumbnail">
                                <img class="large" src="<?php echo e(asset('assets/images/work/work-1.jpg')); ?>" alt="Business Consulting">
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="single-work style-one mt--35">
                        <a href="#">
                            <div class="work-inner">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/work/consultation.png')); ?>" alt="Business Consulting">
                                </div>
                            ...
                            <div class="header-inner">
                                <div class="content">
                                    <div class="content-left">
                                        <div class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/testimonial/img-sm-1.png')); ?>" alt="Business Consulting testimonial">
                                        </div>
                                    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-12">
                    ...
                    <div class="single-blog blog-style-two mt--30" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-4.png')); ?>" alt="Business Consulting Blog"></a>
                                <div class="pmt-blog-meta">
                                    <ul class="all-meta">
                                        <li class="date bg--secondary"><span>20</span></li>
                                        <li class="month"><span>JAN</span></li>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/multiPages/index-two.blade.php ENDPATH**/ ?>