                    ...
                    <div class="header-mida-area style-two ">
                        <div class="logo-area-start">
                            <a href="<?php echo e(route('index')); ?>">
                                <img src="<?php echo e(asset('assets/images/logo/logo-03.png')); ?>"src="<?php echo e(asset('assets/images/logo/logo-03.png')); ?>" alt="logo">
                            </a>
                        </div>
                        ...
                        <div class="actions-area">
                            ...
                            <a href="<?php echo e(route('service')); ?>" class="tmp-btn btn-primary">Get Started Now</a>
...
<?php endif; ?>
    ...
    <div class="startup-banner-swiper-wrapper construction-banner-top-wrapper" id="home">
                ...
                <div class="swiper-slide">
                    ...
                    <div class="tmp-banner-area banner-style-five inconstruction tmp-section-gap banner-bg-construction bg_image">
                        ...
                        <div class="shape-image">
                            <img src="<?php echo e(asset('assets/images/banner/shape/04.png')); ?>"src="<?php echo e(asset('assets/images/banner/shape/04.png')); ?>" alt="shape">
                        </div>
                    </div>
                    <!-- tmp banner area end -->
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumbnails">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/about/8.png')); ?>"src="<?php echo e(asset('assets/images/about/8.png')); ?>" alt="corporate_business">

                            <div class="image-two">
                                <img src="<?php echo e(asset('assets/images/about/03.png')); ?>"src="<?php echo e(asset('assets/images/about/03.png')); ?>" alt="corporate_business">
                            </div>

                            <div class="image-three animated">
                                <img class="" src="<?php echo e(asset('assets/images/about/02.png')); ?>"src="<?php echo e(asset('assets/images/about/02.png')); ?>" alt="corporate_business">
                            </div>

                            <div class="square"></div>

                            <div class="flower">
                                <img src="<?php echo e(asset('assets/images/about/flower.png')); ?>"src="<?php echo e(asset('assets/images/about/flower.png')); ?>" alt="Corporate_Business">
                            </div>
                            ...
                            <div class="product-share">
                                ...
                                <div class="profile-share">
                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/4.png')); ?>"src="<?php echo e(asset('assets/images/about/4.png')); ?>" alt="Business_Corporate"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/5.png')); ?>"src="<?php echo e(asset('assets/images/about/5.png')); ?>" alt="Business_Corporate"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/6.png')); ?>"src="<?php echo e(asset('assets/images/about/6.png')); ?>" alt="Business_Corporate"></a>

                                    <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/7.png')); ?>"src="<?php echo e(asset('assets/images/about/7.png')); ?>" alt="Business_Corporate"></a>
                    ...
                    <div class="about-inner">
                        <div class="section-head text-align-left section-head-one-side">
                            <div class="section-sub-title">
                                <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>"src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Corporate_service">
                        ...
                        <div class="thumbnail-with-title" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/about/about-with-icon.png')); ?>"src="<?php echo e(asset('assets/images/about/about-with-icon.png')); ?>" alt="">
                                <div class="icon">
                ...
                <div class="col-lg-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>"src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Business_Consulting_services">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-6.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-6.svg')); ?>" alt="corporate_Business_Services_agency">
                        </div>
                        <div class="content">
                        ...
                        <a href="<?php echo e(route('service-details')); ?>" class="over_link"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-1.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-1.svg')); ?>" alt="corporate_Business_Services_agency">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-2.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-2.svg')); ?>" alt="corporate_Business_Services_Agency">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-7.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-7.svg')); ?>" alt="corporate_Business_Services_agency">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-8.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-8.svg')); ?>" alt="corporate_Business_Services_agency">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-9.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-9.svg')); ?>" alt="corporate_Business_Services_Agency">
    ...
    <div class="tmp-product-area" id="work">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head">
                        ...
                        <div class="swiper mySwiper-portfolio-1">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-7.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-7.png')); ?>" alt="corporate_business">
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-8.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-8.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-9.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-9.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-10.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-10.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-11.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-11.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-12.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-12.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
            ...
            <div class="row g-5">
                    ...
                    <div class="single-services">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="<?php echo e(asset('assets/images/services/services-round-1.png')); ?>"src="<?php echo e(asset('assets/images/services/services-round-1.png')); ?>" alt="Business consulting services"></a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="<?php echo e(asset('assets/images/services/services-round-2.png')); ?>"src="<?php echo e(asset('assets/images/services/services-round-2.png')); ?>" alt="Business consulting services"></a>
                                <div class="number-bg-round">
                                    <span>02</span>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="<?php echo e(asset('assets/images/services/services-round-3.png')); ?>"src="<?php echo e(asset('assets/images/services/services-round-3.png')); ?>" alt="Business consulting services"></a>
                                <div class="number-bg-round">
                                    <span>03</span>
                                </div>
                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-card card-horizontal">
                                            <div class="card-inner">
                                                ...
                                                <div class="thumbnail">
                                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-1.jpg')); ?>"src="<?php echo e(asset('assets/images/testimonial/testimonial-1.jpg')); ?>" alt="testimonial">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-card card-horizontal">
                                            <div class="card-inner">
                                                ...
                                                <div class="thumbnail">
                                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-2.jpg')); ?>"src="<?php echo e(asset('assets/images/testimonial/testimonial-2.jpg')); ?>" alt="testimonial">
                                                    <div class="icon icon-quote">
                                                        <i class="fa-duotone fa-quote-left"></i>
                                                    </div>
                                                </div>
                        ...
                        <div class="brand-inner tmp-section-gapTop">
                            <ul class="brand-list brand-style-1 justify-content-center justify-content-lg-between">
                                <li data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-1.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-2.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-2.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-3.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-3.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-4.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-4.png')); ?>" alt="Brand Image"></a>
                                </li>
                                <li data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-5.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-5.png')); ?>" alt="Brand Image"></a>
                                </li>
    ...
    <!-- Start Contact Area  -->
    <div class="contact-area-three tmp-section-gapTop" id="contact">
        <div class="bg-shape">
            <img src="<?php echo e(asset('assets/images/cta/02.png')); ?>"src="<?php echo e(asset('assets/images/cta/02.png')); ?>" alt="bussiness-contact">
        </div>
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>"src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Corporate services">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-2.png')); ?>"src="<?php echo e(asset('assets/images/team/team-2.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-3.png')); ?>"src="<?php echo e(asset('assets/images/team/team-3.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                            <div class="team-name content-with-bg">
                                <a href="#" class="name-area">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-1.png')); ?>"src="<?php echo e(asset('assets/images/team/team-1.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                            <div class="team-name content-with-bg">
                                <a href="#" class="name-area">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-12.png')); ?>"src="<?php echo e(asset('assets/images/blog/blog-12.png')); ?>" alt="Business Consulting Blog"></a>
                            ...
                            <div class="blog-content">
                                ...
                                <div class="blog-body">
                                    <a href="<?php echo e(route('blog-details')); ?>" class="title-area">
                                ...
                                <a class="btn-read-more" href="<?php echo e(route('blog-details')); ?>">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-10.png')); ?>"src="<?php echo e(asset('assets/images/blog/blog-10.png')); ?>" alt="Business Consulting Blog"></a>
                                <div class="pmt-blog-meta">
                                    <ul class="all-meta">
                                        <li class="date"><span>20</span></li>
                                        <li class="month"><span>JAN</span></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-11.png')); ?>"src="<?php echo e(asset('assets/images/blog/blog-11.png')); ?>" alt="Business Consulting Blog"></a>
                                <div class="pmt-blog-meta">
                                    <ul class="all-meta">
                                        <li class="date"><span>20</span></li>
                                        <li class="month"><span>JAN</span></li>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-wrapper border-right mr--20">
                            <div class="logo">
                                <a href="<?php echo e(route('index')); ?>">
                                    <img src="<?php echo e(asset('assets/images/logo/logo-02.svg')); ?>"src="<?php echo e(asset('assets/images/logo/logo-02.svg')); ?>" alt="logo">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-wrapper pr--15">
                            ...
                            <div class="single-post">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/footer/small-post.jpg')); ?>"src="<?php echo e(asset('assets/images/footer/small-post.jpg')); ?>" alt="Business_Corporate">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-post">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/footer/small-post-2.jpg')); ?>"src="<?php echo e(asset('assets/images/footer/small-post-2.jpg')); ?>" alt="Business_Corporate">
                                </div>
                                <div class="content">
                                    <div class="date"><i class="fa-light fa-calendar-days"></i><span>12 Feb, 2022</span></div>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/OnePage/onepage_six.blade.php ENDPATH**/ ?>