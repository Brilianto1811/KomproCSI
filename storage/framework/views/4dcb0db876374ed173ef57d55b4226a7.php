            ...
            <div class="header-mida-area style-two">
                <div class="logo-area-start">
                    <a href="<?php echo e(route('index')); ?>">
                        <img src="<?php echo e(asset('assets/images/logo/logo-blue.png')); ?>"src="<?php echo e(asset('assets/images/logo/logo-blue.png')); ?>" alt="logo">
                    </a>
                </div>
                ...
                <div class="button-area-header-two">
                    <a href="<?php echo e(route('contact')); ?>" class="tmp-btn btn-secondary">Get Consulting</a>
...
<!-- Start banner area  -->
<div class="banner-area banner-style-two bg_image tmp-section-gapTop" id="home">
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-5 order-xl-1 order-lg-1 order-md-2 order-sm-2 order-2">
            <div class="banner-inner">
                ...
                <h2 class="title" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">Prosper in this volatile market founding.</h2>
                ...
                <div class="banner-bottom" style="gap: 30px;" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <a href="<?php echo e(route('contact')); ?>" class="tmp-btn btn-secondary">Get Started Now</a>
                    <!-- video icon -->
        ...
        <div class="col-lg-5 offset-lg-2  order-xl-2 order-lg-2 order-md-1 order-sm-1 order-1">
            <div class="banner-two-thumbnail">
                <div class="thumbnail">
                    <img src="<?php echo e(asset('assets/images/banner/banner-two-2.png')); ?>"src="<?php echo e(asset('assets/images/banner/banner-two-2.png')); ?>" alt="Business_Corporate" data-sal-delay="250" data-sal="slide-left" data-sal-duration="800">
                    <div class="product-share product-share-style-two">
                        ...
                        <div class="profile-share">
                            <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/4.png')); ?>"src="<?php echo e(asset('assets/images/about/4.png')); ?>" alt="education"></a>

                            <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/5.png')); ?>"src="<?php echo e(asset('assets/images/about/5.png')); ?>" alt="education"></a>

                            <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/6.png')); ?>"src="<?php echo e(asset('assets/images/about/6.png')); ?>" alt="education"></a>

                            <a href="#" class="avatar" data-tooltip="Mark JOrdan" tabindex="0"><img src="<?php echo e(asset('assets/images/about/7.png')); ?>"src="<?php echo e(asset('assets/images/about/7.png')); ?>" alt="education"></a>
...
<div class="bg-circle">
    <img src="<?php echo e(asset('assets/images/banner/banner-circle.png')); ?>"src="<?php echo e(asset('assets/images/banner/banner-circle.png')); ?>" alt="banner">
</div>

<div class="bg-dolour">
    <img src="<?php echo e(asset('assets/images/banner/banner-dolour.png')); ?>"src="<?php echo e(asset('assets/images/banner/banner-dolour.png')); ?>" alt="banner">
</div>

<div class="bg-blue-circle">
    <img src="<?php echo e(asset('assets/images/banner/blue-circle.png')); ?>"src="<?php echo e(asset('assets/images/banner/blue-circle.png')); ?>" alt="banner">
</div>

<div class="bg-curly-lines">
    <img src="<?php echo e(asset('assets/images/banner/curly-lines.png')); ?>"src="<?php echo e(asset('assets/images/banner/curly-lines.png')); ?>" alt="banner">
</div>
...
<!-- Start Service Area  -->
<div class="service-area tmp-section-gap" id="service">
<div class="container">
    <div class="row" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
        <div class="col-lg-12">
            <div class="section-head">
                ...
                <h2 class="section-title">Our provided services</h2>
            </div>
        </div>
    </div>
    <div class="row g-5">
...
<!-- Start About Area  -->
<div class="about-area about-style-two tmp-section-gapBottom" id="about">
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-6" data-sal-delay="150" data-sal="slide-right" data-sal-duration="800">
            <div class="about-thumbnails about-style-two">
                <img src="<?php echo e(asset('assets/images/about/about-style-2.png')); ?>"src="<?php echo e(asset('assets/images/about/about-style-2.png')); ?>" alt="Business Consulting about">

                <div class="dots animated tada">
                    <img class="tada" src="<?php echo e(asset('assets/images/about/dots.png')); ?>"src="<?php echo e(asset('assets/images/about/dots.png')); ?>" alt="Business Consulting dots">
                </div>
                <div class="scater">
                    <img src="<?php echo e(asset('assets/images/about/scater.png')); ?>"src="<?php echo e(asset('assets/images/about/scater.png')); ?>" alt="Business Consulting scater">
                </div>
...
<div class="container">
    <div class="row" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
        <div class="col-lg-12">
            <div class="section-head color-white style-two">
                ...
                <h2 class="title color-white">Bizper is partnered with 10k+ fastest <br/>
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div class="history-inner style-one">
                <div class="custom-icon">
                    <img src="<?php echo e(asset('assets/images/counter/01.png')); ?>"src="<?php echo e(asset('assets/images/counter/01.png')); ?>" alt="">
                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
            <div class="history-inner style-one">
                <div class="custom-icon">
                    <img src="<?php echo e(asset('assets/images/counter/02.png')); ?>"src="<?php echo e(asset('assets/images/counter/02.png')); ?>" alt="">
                </div>
                <div class="counter-wrapper">
                    <div class="single-counter">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
            <div class="history-inner style-one">
                <div class="custom-icon">
                    <img src="<?php echo e(asset('assets/images/counter/03.png')); ?>"src="<?php echo e(asset('assets/images/counter/03.png')); ?>" alt="">
                </div>
                <div class="counter-wrapper">
                    <div class="single-counter">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
            <div class="history-inner style-one">
                <div class="custom-icon">
                    <img src="<?php echo e(asset('assets/images/counter/04.png')); ?>"src="<?php echo e(asset('assets/images/counter/04.png')); ?>" alt="">
                </div>
                <div class="counter-wrapper">
                    <div class="single-counter">
...
<div class="portfolio-area portfolio-style-two tmp-section-gap" id="product">
<div class="container">
    <div class="row mb--30">
        <div class="col-lg-5 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div class="inner">
                <div class="section-head section-head-one-side text-align-left">
                    <div class="section-sub-title color-secondary">
                        <span class="subtitle">OUR PORTFOLIO</span>
                    </div>
                    <h2 class="title">Let's check our best recent work </h2>
                </div>
                ...
                <a href="<?php echo e(route('project')); ?>" class="tmp-btn btn-with-icon btn-secondary">Our All Works<i class="fa-light fa-arrow-right"></i></a>
            </div>
        </div>
        <div class="col-lg-7 col-md-6 mt_md--80 mt_sm--50 " data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
            <div class="portfolio-inner">
                <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                    <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-1.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-two-1.png')); ?>" alt="corporate business">
                </a>
                <div class="portfolio-tag">
                    ...
                    <a href="<?php echo e(route('projects-details')); ?>" class="icon angle-roted border-none bg-color-white">
    ...
    <div class="row g-5">
        <div class="col-lg-4 col-md-6" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
            <div class="portfolio-inner">
                <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                    <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-2.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-two-2.png')); ?>" alt="corporate business">
                </a>
                <div class="portfolio-tag portfolio-md-tag">
                    ...
                    <a href="<?php echo e(route('projects-details')); ?>" class="icon icon--30 radius-circle border-none bg-color-white">
        ...
        <div class="col-lg-4 col-md-6" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
            <div class="portfolio-inner">
                <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                    <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-3.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-two-3.png')); ?>" alt="corporate business">
                </a>
                <div class="portfolio-tag portfolio-md-tag">
                    <div class="content">
                        <a href="<?php echo e(route('projects-details')); ?>">
        ...
        <div class="col-lg-4 col-md-6" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
            <div class="portfolio-inner">
                <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                    <img src="<?php echo e(asset('assets/images/portfolio/portfolio-two-4.png')); ?>"src="<?php echo e(asset('assets/images/portfolio/portfolio-two-4.png')); ?>" alt="corporate business">
                </a>
                <div class="portfolio-tag portfolio-md-tag">
                    <div class="content">
                        <a href="<?php echo e(route('projects-details')); ?>">
...
<div class="container">
    ...
    <div class="row">
        <div class="work-top-inner">
            <div class="section-head pb-0 section-head-one-side text-align-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="section-sub-title color-white ">
                    <span class="subtitle">WHY CHOOSE US</span>
                </div>
                <h2 class="title color-white">We working for you to build <br/> your business fast</h2>
            </div>
            ...
            <div class="scater-line">
                <img src="<?php echo e(asset('assets/images/work/shape.png')); ?>"src="<?php echo e(asset('assets/images/work/shape.png')); ?>" alt="">
            </div>
        </div>
    </div>
    <div class="row g-5">
        <div class="col-lg-6 col-md-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
            <div class="inner">
                <a href="#">
                    <div class="thumbnail">
                        <img class="large" src="<?php echo e(asset('assets/images/work/work-1.jpg')); ?>"src="<?php echo e(asset('assets/images/work/work-1.jpg')); ?>" alt="Business Consulting">
                    </div>
                </a>
            </div>
        </div>
            ...
            <div class="single-work style-one mt--15">
                <a href="#">
                    <div class="work-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/work/consultation.png')); ?>"src="<?php echo e(asset('assets/images/work/consultation.png')); ?>" alt="Business Consulting">
                        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="section-head pb-40">
                ...
                <h2 class="section-title">What clients have to say</h2>
            </div>
        </div>
    </div>
    <div class="row g-5">
                    ...
                    <div class="header-inner">
                        <div class="content">
                            <div class="content-left">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/testimonial/img-sm-1.png')); ?>"src="<?php echo e(asset('assets/images/testimonial/img-sm-1.png')); ?>" alt="Business Consulting testimonial">
                                </div>
                            </div>
...
<!-- Start Blog Area   -->
<div class="blog-area tmp-section-gap" id="blog">
<div class="container">
    <div class="row g-5">
        <div class="col-lg-3 col-md-4 col-sm-12 col-12">
            <div class="inner">
                <div class="section-head section-head-one-side text-align-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <h2 class="title">Latest news & articles from the blog</h2>
                </div>
...
<div class="contact-area contact-bg-1 bg_image tmp-section-gap" id="contactus">
<div class="container">
    <div class="row">
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/OnePage/onepage_two.blade.php ENDPATH**/ ?>