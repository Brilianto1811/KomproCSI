                ...
                <div class="col-lg-8">
                    <div class="blog-details-left-area border-bottom">
                        <div class="thumbnail-top">
                            <img src="<?php echo e(asset('assets/images/blog/details/01.png')); ?>" alt="Corporate_business">
                        </div>
                        ...
                        <div class="row g-5">
                            <div class="col-lg-6">
                                <div class="thumbnail-50">
                                    <img src="<?php echo e(asset('assets/images/blog/details/02.jpg')); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="thumbnail-50">
                                    <img src="<?php echo e(asset('assets/images/blog/details/03.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="blog-details-discription">
                    ...
                    <div class="blog-details-bottom-area mt--40">
                        ...
                        <div class="author-comment-area">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/blog/details/04.jpg')); ?>" alt="Corporate_Business">
                            </div>
                        ...
                        <div class="comment-area-main-wrapper mt--30">
                            ...
                            <div class="single-comment-audience border-bottom pb--30">
                                <div class="author-image">
                                    <img src="<?php echo e(asset('assets/images/blog/details/05.png')); ?>" alt="Corporate_business">
                                </div>
                            ...
                            <div class="single-comment-audience border-bottom pb--30 pl--50 pl_sm--0">
                                <div class="author-image">
                                    <img src="<?php echo e(asset('assets/images/blog/details/06.png')); ?>" alt="Corporate_business">
                                </div>
                                <div class="right-area-commnet">
                                    <div class="top-area-comment">
                                        <div class="left">
                            ...
                            <div class="single-comment-audience">
                                <div class="author-image">
                                    <img src="<?php echo e(asset('assets/images/blog/details/07.png')); ?>" alt="Corporate_business">
                                </div>
                                <div class="right-area-commnet">
                                    <div class="top-area-comment">
                                        <div class="left">
                            ...
                            <div class="body mt--50">
                                ...
                                <div class="single-blog-recent-post-sidebar">
                                    <a href="#" class="thumbnail">
                                        <img src="<?php echo e(asset('assets/images/blog/blog-4.jpg')); ?>" alt="blog-Post">
                                        <div class="inner">
                                ...
                                <div class="single-blog-recent-post-sidebar">
                                    <a href="#" class="thumbnail">
                                        <img src="<?php echo e(asset('assets/images/blog/blog-5.jpg')); ?>" alt="blog-Post">
                                        <div class="inner">
                                            <span class="post-time">
                                                <i class="fa-regular fa-clock"></i>
                                                12 Jan, 2023
                                ...
                                <div class="single-blog-recent-post-sidebar">
                                    <a href="#" class="thumbnail">
                                        <img src="<?php echo e(asset('assets/images/blog/blog-6.jpg')); ?>" alt="blog-Post">
                                        <div class="inner">
                                            <span class="post-time">
                                                <i class="fa-regular fa-clock"></i>
                                                12 Jan, 2023
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/blog-details.blade.php ENDPATH**/ ?>