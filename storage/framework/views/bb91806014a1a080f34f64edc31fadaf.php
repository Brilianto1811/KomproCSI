                ...
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Business Consulting services">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/services/services-icon-1.png')); ?>" alt="Business consulting services">
                            </div>
                            ...
                            <div class="number">
                                <img src="<?php echo e(asset('assets/images/services/icon-01.png')); ?>" alt="Business Consulting number">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/services/services-icon-2.png')); ?>" alt="Business consulting services">
                            </div>
                            <div class="services-content">
                                <a href="<?php echo e(route('service-details')); ?>">
                            ...
                            <div class="number">
                                <img src="<?php echo e(asset('assets/images/services/icon-02.png')); ?>" alt="Business Consulting number">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-services service-style-one">
                        <div class="services-inner  with-shadow card-bg-color">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/services/services-icon-3.png')); ?>" alt="Business consulting services">
                            </div>
                            <div class="services-content">
                                <a href="<?php echo e(route('service-details')); ?>">
                            ...
                            <div class="number">
                                <img src="<?php echo e(asset('assets/images/services/icon-03.png')); ?>" alt="Business Consulting number">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="inner">
                        <a href="#">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('assets/images/work/work-1.jpg')); ?>" alt="Business Consulting">
                            </div>
                        </a>
    ...
    <div class="faq-area faq-bg-image bg_image tmp-section-gap">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img src="<?php echo e(asset('assets/images/faq/faq-1.png')); ?>" alt="Business Consulting FAQ">
                    </div>
                </div>
                <div class="col-lg-6">
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/service.blade.php ENDPATH**/ ?>