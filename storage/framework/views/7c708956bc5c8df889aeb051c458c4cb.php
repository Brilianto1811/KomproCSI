            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 order-xl-2 order-md-1 order-sm-1 order-1 mb_md--30 mb_sm--30">
                    <div class="frame-image-about-company">
                        <img src="<?php echo e(asset('assets/images/about/about-3.png')); ?>" alt="Banner Images">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center  plr_sm--15 plr_md--15">
            ...
            <div class="col-lg-6">
                <div class="thumbnail image-right-content">
                    <img src="<?php echo e(asset('assets/images/about/about-large.jpg')); ?>" alt="split Images">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12">
                    <div class="brand-main-wrapper-company">
                        <div class="tmp-brand-section-start">
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/01.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/02.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/03.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/08.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/05.png')); ?>" alt="brand">
                            </a>
                        </div>
                        <div class="tmp-brand-section-start">
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/06.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/07.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/08.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/09.png')); ?>" alt="brand">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/brand/10.png')); ?>" alt="brand">
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/multiPages/index-eight.blade.php ENDPATH**/ ?>