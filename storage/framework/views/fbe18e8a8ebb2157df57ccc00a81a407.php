                        ...
                        <div class="portfolio_wrap">
                            <div class="filter row portfolio-feed personal g-5">
                                ...
                                <div class="flash grid-item-p element-item transition design col-md-4 col-sm-6" data-category="transition">
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/product/02.jpg')); ?>" alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                                <span class="left">Mobile App Design</span>
                                ...
                                <div class="flash grid-item-p element-item transition photo col-md-4 col-sm-6" data-category="transition">
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/product/03.jpg')); ?>" alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                                <span class="left">Mobile App Design</span>
                                ...
                                <div class="flash grid-item-p element-item transition photo style col-md-4 col-sm-6" data-category="transition" style="position: absolute; left: 0px; top: 509.516px;">
                                    ...
                                    <div class="tmp-single-portfolio-item">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/product/04.jpg')); ?>" alt="personal_portfolio">
                                        </a>
                                        <div class="tmp-inner-content">
                                            <div class="top-item">
                                                <span class="left">Mobile App Design</span>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/multiPages/index-five.blade.php ENDPATH**/ ?>