                    ...
                    <div class="main-header-one-wrapper">
                        ...
                        <div class="tmp-nav-area-one header--sticky">
                            <div class="logo-md-sm-device">
                                <a href="#" class="logo">
                                    <img src="<?php echo e(asset('assets/images/logo/logo-01.svg')); ?>" alt="corporate_business-logo">
                                </a>
                            </div>
...
<?php endif; ?>
                ...
                <div class="swiper-slide">
                    <div class="tmp-banner-area bg_image-1 bg_image banner-one-height-control construction-2 tmp-section-gap">
                        <div class="shape-image-banner-one">
                            <img src="<?php echo e(asset('assets/images/banner/shape/01.png')); ?>" alt="banner" class="one">
                            <img src="<?php echo e(asset('assets/images/banner/shape/02.png')); ?>" alt="banner" class="two">
                            <img src="<?php echo e(asset('assets/images/banner/shape/03.png')); ?>" alt="banner" class="three">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service feature-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-6.svg')); ?>" alt="corporate_Business_Services_agency">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service feature-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-1.svg')); ?>" alt="corporate_Business_Services_agency">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service feature-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-2.svg')); ?>" alt="corporate_Business_Services_Agency">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service feature-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-3.svg')); ?>" alt="corporate_Business_Services_agency">
                ...
                <div class="col-lg-6">
                    <div class="about-thumbnail-construction">
                        <div class="image-large">
                            <img src="<?php echo e(asset('assets/images/about/about-2.jpg')); ?>" alt="construction_business">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Business_Consulting_services">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-1.png')); ?>" alt="corporate Business Services">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-2.png')); ?>" alt="corporate Business Services">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-3.png')); ?>" alt="corporate Business Services">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-4.png')); ?>" alt="corporate Business Services">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-5.png')); ?>" alt="corporate Business Services">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="650" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/service-icon-6.png')); ?>" alt="corporate Business Services">
            ...
            <div class="row g-5">
                    ...
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#">
                                    <img src="<?php echo e(asset('assets/images/services/services-round-1.png')); ?>" alt="Business consulting services">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="<?php echo e(asset('assets/images/services/services-round-2.png')); ?>" alt="Business consulting services">
                                    <div class="number-bg-round">
                                        <span>02</span>
                                    </div>
                                </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-services construction">
                        <div class="services-inner">
                            <div class="thumbnail thumbnail-rounded border-top-left hover-animation">
                                <a href="#"><img src="<?php echo e(asset('assets/images/services/services-round-3.png')); ?>" alt="Business consulting services">
                                    <div class="number-bg-round">
                                        <span>03</span>
                                    </div>
                            </div></a>
                        ...
                        <div class="swiper mySwiper-portfolio-2-cons">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-8.png')); ?>" alt="corporate_business">
                                        </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-9.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-10.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-11.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-12.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="signle-product-start" data-tmp-cursor="lg text-secondary transparent fw-bold" data-tmp-cursor-icon="fa-solid fa-arrow-up-right">
                                        <a href="<?php echo e(route('projects-details')); ?>" class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-7.png')); ?>" alt="corporate_business">
                                        </a>
                                        <div class="inner-content">
                                            <a href="<?php echo e(route('projects-details')); ?>">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 pr--30">
                    <div class="thumbnail-faq-cons">
                        <img src="<?php echo e(asset('assets/images/faq/faq-3.jpg')); ?>" alt="Business Consulting FAQ">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-head">
                        <div class="section-sub-title center-title">
                            <img src="<?php echo e(asset('assets/images/services/section-custom-menubar.png ')); ?>" alt="Corporate services">
            ...
            <div class="row g-5">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-2.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-3.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                            <div class="team-name content-with-bg">
                                <a href="#" class="name-area">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-5.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                            <div class="team-name content-with-bg">
                                <a href="#" class="name-area">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" class="thumbnail" data-tmp-cursor="lg transparent fw-bold" data-tmp-cursor-text="View Details">
                            <img src="<?php echo e(asset('assets/images/team/team-1.png')); ?>" alt="Corporate team">
                        </a>
                        <div class="content">
                            <div class="team-name content-with-bg">
                                <a href="#" class="name-area">
                ...
                <div class="col-lg-12">
                    <div class="large-video-playing grow-thumbnail">
                        <video autoplay="" muted="" loop="" playsinline="" preload="metadata">
                            <source src="<?php echo e(asset('assets/images/work/01.mp4')); ?>" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-card card-horizontal">
                                            <div class="card-inner">
                                                ...
                                                <div class="thumbnail">
                                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-1.jpg')); ?>" alt="testimonial">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-card card-horizontal">
                                            <div class="card-inner">
                                                ...
                                                <div class="thumbnail">
                                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-2.jpg')); ?>" alt="testimonial">
                                                    <div class="icon icon-quote">
                                                        <i class="fa-duotone fa-quote-left"></i>
                                                    </div>
                                                </div>
                        ...
                        <div class="brand-inner tmp-section-gapTop">
                            <ul class="brand-list brand-style-1 justify-content-center justify-content-lg-between">
                                <li data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-2.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-3.png')); ?>" alt="Brand Image"></a>
                                </li>

                                <li data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-4.png')); ?>" alt="Brand Image"></a>
                                </li>
                                <li data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                                    <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-5.png')); ?>" alt="Brand Image"></a>
                                </li>
    ...
    <div class="contact-area-three tmp-section-gapTop">
        <div class="bg-shape">
            <img src="<?php echo e(asset('assets/images/cta/02.png')); ?>" alt="bussiness-contact">
        </div>
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5">
        ...
        <div class="container">
            <div class="join-us-one__inner">
                <div class="join-us-one__shape-1">
                    <img src="<?php echo e(asset('assets/images/shapes/join-us-one-shape-1.png')); ?>" alt="">
                </div>
                <div class="join-us-one__shape-2">
                    <img src="<?php echo e(asset('assets/images/shapes/join-us-one-shape-2.png')); ?>" alt="">
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col1-2" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-12.png')); ?>" alt="Business Consulting Blog"></a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col1-2" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-blog">
                        <div class="blog-inner">
                            <div class="thumbnail">
                                <a href="<?php echo e(route('blog-details')); ?>"><img src="<?php echo e(asset('assets/images/blog/blog-11.png')); ?>" alt="Business Consulting Blog"></a>
                                <div class="pmt-blog-meta">
                                    <ul class="all-meta">
                                        <li class="date"><span>20</span></li>
                                        <li class="month"><span>JAN</span></li>
                        ...
                        <div class="single-footer-wrapper border-right mr--20">
                            <div class="logo">
                                <a href="<?php echo e(route('index')); ?>">
                                    <img src="<?php echo e(asset('assets/images/logo/logo-02.svg')); ?>" alt="logo">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-wrapper pr--15">
                            ...
                            <div class="single-post">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/footer/small-post.jpg')); ?>" alt="Business_Corporate">
                                </div>
                                <div class="content">
                            ...
                            <div class="single-post">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/footer/small-post-2.jpg')); ?>" alt="Business_Corporate">
                                </div>
                                <div class="content">
                                    <div class="date"><i class="fa-light fa-calendar-days"></i><span>12 Feb, 2022</span></div>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/multiPages/index-seven.blade.php ENDPATH**/ ?>