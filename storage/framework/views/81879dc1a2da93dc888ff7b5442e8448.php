            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="single-projects-one-col-1">
                        <a href="<?php echo e(route('blog-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/blog/blog-07.jpg')); ?>" alt="">
                        </a>
                        <div class="inner-blog-single">
                            <div class="inner">
                                ...
                                <a href="<?php echo e(route('blog-details')); ?>" class="read-more-btn">Read more <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-projects-one-col-1">
                        <a href="<?php echo e(route('blog-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/blog/blog-08.jpg')); ?>" alt="">
                        </a>
                        <div class="inner-blog-single">
                            <div class="inner">
                                <div class="category">
                    ...
                    <div class="single-projects-one-col-1">
                        <a href="<?php echo e(route('blog-details')); ?>" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/blog/blog-09.jpg')); ?>" alt="">
                        </a>
                        <div class="inner-blog-single">
                            <div class="inner">
                                <div class="category">
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/blog-col-1.blade.php ENDPATH**/ ?>