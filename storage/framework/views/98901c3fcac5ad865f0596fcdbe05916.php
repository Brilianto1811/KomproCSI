            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumbnails">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/about/01.png')); ?>" alt="corporate business">

                            <div class="image-two">
                                <img src="<?php echo e(asset('assets/images/about/03.png')); ?>" alt="corporate business">
                            </div>

                            <div class="image-three animated">
                                <img class="" src="<?php echo e(asset('assets/images/about/02.png')); ?>" alt="corporate business">
                            </div>

                            <div class="square"></div>

                            <div class="flower">
                                <img src="<?php echo e(asset('assets/images/about/flower.png')); ?>" alt="">
                            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="single-team">
                        <a href="<?php echo e(route('team-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/about.blade.php ENDPATH**/ ?>