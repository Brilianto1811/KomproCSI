                        ...
                        <div class="inner-content-banner-four">
                            ...
                            <div class="content-wrapper">
                                ...
                                <div class="button-area-banner-one">
                                    <a href="<?php echo e(route('service')); ?>" class="tmp-btn btn-primary"><i class="fa-light fa-users"></i> Get In Touch With Us</a>
                                    <!-- video icon -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trusted-clients-agency-wrapper">
                        ...
                        <div class="cilents-agency-wrapper">
                            <div class="single-clients">
                                <img src="<?php echo e(asset('assets/images/brand/brand-1.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-1.png')); ?>" alt="corporate_Business">
                            </div>
                            <div class="single-clients">
                                <img src="<?php echo e(asset('assets/images/brand/brand-2.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-2.png')); ?>" alt="corporate_Business">
                            </div>
                            <div class="single-clients">
                                <img src="<?php echo e(asset('assets/images/brand/brand-3.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-3.png')); ?>" alt="corporate_Business">
                            </div>
                            <div class="single-clients">
                                <img src="<?php echo e(asset('assets/images/brand/brand-4.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-4.png')); ?>" alt="corporate_Business">
                            </div>
                            <div class="single-clients">
                                <img src="<?php echo e(asset('assets/images/brand/brand-5.png')); ?>"src="<?php echo e(asset('assets/images/brand/brand-5.png')); ?>" alt="corporate_Business">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-4.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-4.svg')); ?>" alt="corporate_Business_Services_agency">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="650" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-inner financial-service-inner agency-service">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/images/services/agency-5.svg')); ?>"src="<?php echo e(asset('assets/images/services/agency-5.svg')); ?>" alt="corporate_Business_Services_agency">
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/OnePage/onepage_four.blade.php ENDPATH**/ ?>