            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="team-details-thumb">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/team-details/team-1.jpg')); ?>" alt="team">
                        </div>
                        <div class="content">
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/pages/team-details.blade.php ENDPATH**/ ?>