                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="thumbnail position-relative">
                                        <img src="<?php echo e(asset('assets/images/projects-details/projects-details.jpg')); ?>" alt="projects-details">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="thumbnail position-relative">
                            ...
                            <div class="projects-details-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/projects-details/challen-1.jpg')); ?>" alt="project details">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/projects-details/challen-2.jpg')); ?>" alt="project details">
                                        </div>
...
<?php echo $__env->make('layouts.layout1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/pages/projects-details-2.blade.php ENDPATH**/ ?>