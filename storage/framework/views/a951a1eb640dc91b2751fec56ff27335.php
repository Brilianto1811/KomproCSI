...
<?php endif; ?>
                        ...
                        <div class="actions-area">
                            ...
                            <a href="<?php echo e(route('contact')); ?>" class="tmp-btn btn-gradiant">Get Started Now</a>
...
<?php endif; ?>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/banner/banner-three.jpg')); ?>" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
                            ...
                            <div class="banner-bottom justify-content-center" style="gap: 30px;">
                                <a href="<?php echo e(route('service')); ?>" class="tmp-btn btn-gradiant">Get Started Now</a>
                                <a href="<?php echo e(route('contact')); ?>" class="tmp-btn btn-gradiant-2">Contact Us</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/banner/banner-four.jpg')); ?>" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
                                Start your upcoming modern consulting
                ...
                <div class="swiper-slide">
                    <div class="slider-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/banner/banner-five.jpg')); ?>" alt="marketing consulting">
                        </div>
                        <div class="content">
                            <h2 class="title">
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    ...
                    <div class="service-single-three">
                        ...
                        <a class="link-over" href="<?php echo e(route('service')); ?>"></a>
                    </div>
                    <!-- single -service end -->
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="about-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/about/about-4.jpg')); ?>" alt="about">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="small-meta">
                                        <div class="thumbnail">
                                            <img src="<?php echo e(asset('assets/images/about/about-meta.jpg')); ?>" alt="about-meta">
                                        </div>
                                        <div class="content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl--60 pl_sm--10" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="skill-inner">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/about/about-5.jpg')); ?>" alt="about">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-top-inner">
                        ...
                        <div class="btn-group">
                            <a href="<?php echo e(route('project')); ?>" class="tmp-btn btn-gradiant">Explore More</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 mt--10">
                <div class="col-lg-6 col-md-6 col-sm-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/potrfolio-10.jpg')); ?>" alt="corporate business">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-11.jpg')); ?>" alt="corporate business">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-12.jpg')); ?>" alt="business Corporate portfolio">
                        </a>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-sal-delay="450" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-13.jpg')); ?>" alt="business Corporate portfolio">
                        </a>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-sal-delay="550" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-14.jpg')); ?>" alt="business Corporate portfolio">
                        </a>
                        <div class="portfolio-tag bg-gradiant portfolio-sm-tag">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12" data-sal-delay="650" data-sal="slide-up" data-sal-duration="800">
                    <div class="portfolio-inner">
                        <a href="<?php echo e(route('projects-details')); ?>" data-tmp-cursor="lg" data-tmp-cursor-text="View Details" class="thumbnail">
                            <img src="<?php echo e(asset('assets/images/portfolio/portfolio-15.jpg')); ?>" alt="corporate business">
                        </a>
                        <div class="portfolio-tag bg-gradiant">
                            <div class="content">
                                <a href="<?php echo e(route('projects-details')); ?>">
                ...
                <div class="row g-5">
                        ...
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-sm-img.png')); ?>" alt="Corporate Business">
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-sm-img-1.png')); ?>" alt="Corporate Business">
                                </a>
                                <div class="client-info">
                                    <a href="#">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="tmp-testimonial-box style-three">
                            ...
                            <div class="clint-info-wrapper">
                                <a href="#" class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/testimonial/testimonial-sm-img-2.png')); ?>" alt="Corporate Business">
                                </a>
                                <div class="client-info">
                                    <a href="#">
                ...
                <div class="col-lg-12">
                    <div class="main-faq">
                        <div class="shape-image">
                            <img src="<?php echo e(asset('assets/images/faq/03.png')); ?>" alt="business_faq">
                        </div>
                        <div class="row g-0 align-items-center">
                            <div class="col-lg-5">
                                <div class="thumbnail">
                                    <img src="<?php echo e(asset('assets/images/faq/faq-img-2.png')); ?>" alt="">
                                </div>
                            </div>
    ...
    <div class="quick-action-area quick-action-style-one">
        ...
        <div class="dot-top">
            <div class="thumbnail">
                <img src="<?php echo e(asset('assets/images/quick-action/1.png')); ?>" alt="dot">
            </div>
        </div>
        <div class="carly-line">
            <div class="thumbnail">
                <img src="<?php echo e(asset('assets/images/quick-action/carly-line.png')); ?>" alt="">
            </div>
        </div>
        ...
        <div class="shape">
            <div class="thumbnail">
                <img src="<?php echo e(asset('assets/images/quick-action//quick-action-1.png')); ?>" alt="dot">
            </div>
        </div>
        <div class="shape-2">
            <div class="thumbnail">
                <img src="<?php echo e(asset('assets/images/quick-action/shape-2.png')); ?>" alt="dot">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theme\Themes Park\Bizper\Laravel\Bizper\resources\views/multiPages/index-three.blade.php ENDPATH**/ ?>