                        ...
                        <div class="header-top-inner">
                            <div class="left-information-area">
                                <div class="location-area">
                                    ...
                                    <a href="https://maps.app.goo.gl/xXTVGmtoiHpCwgoZ6" target="_blank">Cifor, Bogor, Jawa Barat</a>
                                </div>
                    ...
                    <div class="main-header-one-wrapper">
                        <div class="header-mida-area">
                            <div class="logo-area-start">
                                <a class="logo" href="#">
                                    <img src="assets/images/logo/csi_logo2.png" alt="Corporate_business_logo" width="100" height="auto">
                                </a>
                            </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="tmp-banner-area bg_image-1 bg_image banner-one-height-control tmp-section-gap">
                        <div class="shape-image-banner-one">
                            <img src="assets/images/logo/wp5.jpg" alt="banner" class="one">
                            <img src="assets/images/logo/wp1.jpg" alt="banner" class="two">
                            <img src="assets/images/logo/wp4.jpg" alt="banner" class="three">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6">
                ...
                <div class="swiper-slide">
                    <div class="tmp-banner-area bg_image-2 bg_image banner-one-height-control tmp-section-gap">
                        <div class="shape-image-banner-one">
                            <img src="assets/images/logo/wp2.jpg" alt="banner" class="one">
                            <img src="assets/images/logo/wp4.jpg" alt="banner" class="two">
                            <img src="assets/images/logo/wp3.jpg" alt="banner" class="three">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6">
                ...
                <div class="swiper-slide">
                    <div class="tmp-banner-area bg_image-3 bg_image banner-one-height-control tmp-section-gap">
                        <div class="shape-image-banner-one">
                            <img src="assets/images/logo/wp1.jpg" alt="banner" class="one">
                            <img src="assets/images/logo/wp3.jpg" alt="banner" class="two">
                            <img src="assets/images/logo/wp2.jpg" alt="banner" class="three">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6">
...
<?php echo $__env->make('layouts.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\RIAN FILE!!!\PROJEK WEB CSI\bizperlaravel-10\bizperlaravel-10\Bizper\resources\views/index.blade.php ENDPATH**/ ?>